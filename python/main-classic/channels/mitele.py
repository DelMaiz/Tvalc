...
def directos(item=None):
    ...
    itemlist.append( Item(channel=__channel__, action="play", title="Telecinco", url="https://livehlsdai-i.akamaihd.net/hls/live/571640/telecinco/bitrate_4.m3u8", thumbnail="http://media.tvalacarta.info/canales/128x128/telecinco.png", category="Nacionales", folder=False) )
    itemlist.append( Item(channel=__channel__, action="play", title="Cuatro", url="https://livehlsdai-i.akamaihd.net/hls/live/571643/cuatro/bitrate_4.m3u8", thumbnail="http://media.tvalacarta.info/canales/128x128/cuatro.png", category="Nacionales", folder=False) )
